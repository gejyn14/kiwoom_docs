...
키움증권 REST API 국내주식 계좌 관련 TR 문서가 완성되었습니다. 총 **25개의 TR**이 포함되어 있으며, 다음과 같이 분류됩니다:
...
각 TR에는 상세한 요청/응답 사양, Python 예제 코드, 실제 요청/응답 예제가 포함되어 있어 개발자가 즉시 활용할 수 있습니다.

*문서 작성 시간: 2025년 6월 18일*